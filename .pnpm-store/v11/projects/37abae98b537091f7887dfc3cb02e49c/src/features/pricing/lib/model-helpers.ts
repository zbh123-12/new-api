 ...
 *
 * Group ratios are intentionally hidden from end users; show a neutral 1x
 * regardless of which group they view. Backend relay still applies the real
 * ratio at billing time.
 */
