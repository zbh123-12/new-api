...
const options = [
  ...
  { value: 'default', label: 'default', desc: 'User group' },
...
describe('API key group combobox Auto effect', () => {
  test('rings the selected Auto trigger without exposing the group ratio badge', () => {
    ...
    // Group ratios are hidden from users, so no ratio badge should render
    expect(
    ...
    expect(defaultOption).not.toHaveTextContent(/Ratio/)
    expect(
