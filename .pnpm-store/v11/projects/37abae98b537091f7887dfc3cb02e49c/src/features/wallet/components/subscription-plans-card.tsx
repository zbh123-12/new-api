                      ...
                      <div className='text-muted-foreground mt-1'>
                        ...
                        {totalAmount > 0 ? (
                          <Tooltip>
                            ...
                            >
                              {formatRawTokensWithUnit(usedAmount, t('tokens'), t('Unlimited'))}/
                              {formatRawTokensWithUnit(totalAmount, t('tokens'), t('Unlimited'))} · {t('Remaining')}{' '}
                              {formatRawTokensWithUnit(remainAmount, t('tokens'), t('Unlimited'))}
                            </TooltipTrigger>
                            <TooltipContent>
            ...
            {plans.map((p, index) => {
              ...
              const benefits = [
                ...
                formatResetPeriod(plan, t) !== t('No Reset')
                  ...
                  : null,
                totalAmount > 0
                  ? `${t('Total Quota')}: ${formatRawTokensWithUnit(totalAmount, t('tokens'), t('Unlimited'))}`
