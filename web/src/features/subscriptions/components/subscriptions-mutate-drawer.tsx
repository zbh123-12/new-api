                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          min={0}
                          step={1}
                          placeholder={t('Enter quota in tokens')}
                          onChange={(e) =>
                            field.onChange(
                      ...
                      <FormDescription>
                        {t(
                          'Total quota included in the plan (in raw tokens), usable per billing period. 0 means unlimited.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <MultiSelect
                        ...
                        placeholder={t('Select models (empty for all)')}
                      />
                    </FormControl>
                    <FormDescription>
                      {t(
                        'Restrict which models this plan can be used for. Empty = no restriction.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
